...
export const AuthResourceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        v1AuthExchangePost: async (exchangeCodeRequest: ExchangeCodeRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'exchangeCodeRequest' is not null or undefined
            assertParamExists('v1AuthExchangePost', 'exchangeCodeRequest', exchangeCodeRequest)
            const localVarPath = `/v1/auth/exchange`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(exchangeCodeRequest, localVarRequestOptions, configuration)
...
export const AuthResourceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async v1AuthExchangePost(exchangeCodeRequest: ExchangeCodeRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.v1AuthExchangePost(exchangeCodeRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AuthResourceApi.v1AuthExchangePost']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const AuthResourceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        v1AuthExchangePost(exchangeCodeRequest: ExchangeCodeRequest, options?: RawAxiosRequestConfig): AxiosPromise<any> {
            return localVarFp.v1AuthExchangePost(exchangeCodeRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Login
...
export class AuthResourceApi extends BaseAPI {
     ...
     * @memberof AuthResourceApi
     */
    public v1AuthExchangePost(exchangeCodeRequest: ExchangeCodeRequest, options?: RawAxiosRequestConfig) {
        return AuthResourceApiFp(this.configuration).v1AuthExchangePost(exchangeCodeRequest, options).then((request) => request(this.axios, this.basePath));
    }
